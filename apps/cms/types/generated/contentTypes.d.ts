...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Travel guides, tips, and editorial content';
    displayName: 'Article';
    pluralName: 'articles';
  ...
  attributes: {
    ...
    relatedArticles: Schema.Attribute.Relation<
      ...
      'api::article.article'
    >;
    relatedTours: Schema.Attribute.Relation<'manyToMany', 'api::tour.tour'>;
...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Content authors and local experts';
    displayName: 'Author';
    pluralName: 'authors';
    singularName: 'author';
  };
  ...
  attributes: {
    ...
    isLocalExpert: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::author.author'
...
export interface ApiCityCity extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Cities and regions within destinations (e.g., Zanzibar, Dar es Salaam)';
    displayName: 'City';
    pluralName: 'cities';
    singularName: 'city';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    quickFacts: Schema.Attribute.Component<'shared.city-facts', false>;
    seoMetadata: Schema.Attribute.Component<'shared.seo', false>;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
...
export interface ApiDestinationDestination extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Country-level travel destinations (e.g., Tanzania)';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    quickFacts: Schema.Attribute.Component<'shared.destination-facts', false>;
    seoMetadata: Schema.Attribute.Component<'shared.seo', false>;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiHotelHotel extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Hotels and accommodation listings';
    displayName: 'Hotel';
    pluralName: 'hotels';
    singularName: 'hotel';
  };
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Agency case studies and portfolio projects';
    displayName: 'Project';
    pluralName: 'projects';
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    videoShowcase: Schema.Attribute.Media<'videos'>;
  };
}
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Agency services offered';
    displayName: 'Service';
    pluralName: 'services';
...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Bookable tours and experiences';
    displayName: 'Tour';
    pluralName: 'tours';
    singularName: 'tour';
  };
  ...
  attributes: {
    ...
    priceChild: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    seoMetadata: Schema.Attribute.Component<'shared.seo', false>;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
