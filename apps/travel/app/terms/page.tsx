                ...
                <div className={styles.container}>
                    <article className={styles.documentCard}>
                        ...
                        <div className={styles.content}>
                            ...
                            <p>
                                By accessing or using Nyota Travel platform and services, you agree to be bound by these Terms of Service and all applicable laws and regulations.
                                If you do not agree with any of these terms, you are prohibited from using or accessing this site.
                            </p>

                            <h2>2. Travel Advisory Services</h2>
                            <p>
                                Nyota Travel acts as a travel advisor and booking facilitator. We curate experiences and connect you with trusted local operators in Tanzania.
                            ...
                            <p>
                                While we carefully vet our partners, Nyota Travel is not liable for any personal injury, property damage, accident, delay, or irregularity which may be occasioned by any act or default of any company or person engaged in conveying the passenger or in carrying out the arrangements of the tour.
                            </p>
